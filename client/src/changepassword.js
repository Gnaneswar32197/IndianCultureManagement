...
import './changepassword.css';
import { callApi, errorResponse, getSession } from './main';
import resetpassword from './images/resetpassword.png'; // Import the image
...
class ChangePassword extends React.Component {
    ...
    render() {
        return(
            <div className='full-height'>
                <div className='cpcontent'>
                    <img src={resetpassword} alt="resetpassword" className="resetpassword" /> {/* Display the imported image */}
                    <h3>Change Your Password</h3>
                    <table style={tableStyle}>
                        <tr>
                            <td>Current Password* <input type='text' id='T1' className='txtbox' /></td>
